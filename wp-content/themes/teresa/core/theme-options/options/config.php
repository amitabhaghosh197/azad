        ...
        class Redux_Framework_sample_config {
				...
				$this->sections[] = array(
                    ...
                    'fields' => array(
						...
						array(
                            ...
                            //'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                            'desc'     => __( '', 'redux-framework-demo' ),
                            'subtitle' => __( 'Upload <strong>FAvicon</strong> using the WordPress native uploader', 'redux-framework-demo' ),
                            'default'  => array( 'url' => 'http://s.wordpress.org/style/images/codeispoetry.png' ),
                            //'hint'      => array(
                            //    'title'     => 'Hint Title',
                            //    'content'   => 'This is a <b>hint</b> for the media field with a Title.',
            ...
            public function setArguments() {
                ...
                if ( ! isset( $this->args['global_variable'] ) || $this->args['global_variable'] !== false ) {
                    ...
                    $this->args['intro_text'] = sprintf( __( '<p>For any quiries please contact <a target="_blank" class="button button-primary" href="http://damiracle.com/contact/">Contact</a></p>', 'redux-framework-demo' ), $v );
                } else {
