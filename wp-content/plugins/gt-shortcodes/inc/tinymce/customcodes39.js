...
(function() {  
    tinymce.PluginManager.add('gtbutton', function(editor, url) {
    // Add a button that opens a window
    editor.addButton('gtbutton', {
        type: 'splitbutton',
        text: 'GT',
        title: 'GT Shortcodes',
        tooltip: 'GT Shortcodes',
        icon: false,
        menu: [
                {text: 'Accordion', classes: 'gt', icon: true, image: url + '/fus_accordion.png', onclick: function() {
                    // Open window
                ...
                {text: 'Alert', classes: 'gt', icon: true, image: url + '/fus_alert.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                    W = W - 80;
                    H = H - 120;
                ...
                {text: 'Animation', classes: 'gt', icon: true, image: url + '/fus_animation.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Numbers', classes: 'gt', icon: true, image: url + '/fus_anim_num.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Banner Ads', classes: 'gt', icon: true, image: url + '/fus_banner.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Blockquote', classes: 'gt', icon: true, image: url + '/fus_blockquote.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Button', classes: 'gt', icon: true, image: url + '/fus_button.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Carousel', classes: 'gt', icon: true, image: url + '/fus_carousel.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Charts', classes: 'gt', icon: true, image: url + '/fus_chart.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Code', classes: 'gt', icon: true, image: url + '/fus_code.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Columns', classes: 'gt', icon: true, image: url + '/fus_columns.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Font Awesome', classes: 'gt', icon: true, image: url + '/fus_font_awesome.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Glyph', classes: 'gt', icon: true, image: url + '/fus_glyph.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Google PieChart', classes: 'gt', icon: true, image: url + '/fus_google_pie_chart.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                            tb_show( 'GT Google PieChart Shortcode', '#TB_inline?width=' + W + '&height=' + H + '&inlineId=gt-googlepiechart-form' );
                }},
                {text: 'Google Map', classes: 'gt', icon: true, image: url + '/fus_gmap.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Highlight', classes: 'gt', icon: true, image: url + '/fus_highlight.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Horizontal Rules', classes: 'gt', icon: true, image: url + '/fus_horizontal.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Icon List', classes: 'gt', icon: true, image: url + '/fus_icon_list.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Label', classes: 'gt', icon: true, image: url + '/fus_label.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Lazy Load', classes: 'gt', icon: true, image: url + '/fus_lazy.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Popover', classes: 'gt', icon: true, image: url + '/fus_popover.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Pricing Table', classes: 'gt', icon: true, image: url + '/fus_ptable.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Progress Bar', classes: 'gt', icon: true, image: url + '/fus_progress.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'QR Codes', classes: 'gt', icon: true, image: url + '/fus_qrcodes.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Switch', classes: 'gt', icon: true, image: url + '/fus_switch.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Tab', classes: 'gt', icon: true, image: url + '/fus_tab.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Table', classes: 'gt', icon: true, image: url + '/fus_carousel.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Tooltip', classes: 'gt', icon: true, image: url + '/fus_tooltip.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Video', classes: 'gt', icon: true, image: url + '/fus_video.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
                ...
                {text: 'Visibility', classes: 'gt', icon: true, image: url + '/fus_visibility.png', onclick: function() {
                    // Open window
                    var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
                            W = W - 80;
                            H = H - 120;
