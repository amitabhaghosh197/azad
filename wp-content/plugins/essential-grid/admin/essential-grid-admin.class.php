...
class Essential_Grid_Admin extends Essential_Grid_Base {
	...
	public static function add_to_VC() {
		...
		add_shortcode_param('ess_grid_shortcode', array('Essential_Grid_Admin', 'ess_grid_shortcode_settings_field'), EG_PLUGIN_URL.'/admin/assets/js/vc.js'); //, EG_PLUGIN_URL.'/admin/assets/js/tinymce-shortcode-script.js')
	...
	public static function ess_grid_shortcode_settings_field($settings, $value) {
		...
		return '<div class="ess_grid_shortcode_block" style="opacity: 0;">'
