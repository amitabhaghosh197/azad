 ...
 */
	...
	<ul class="eg-option-tabber-wrapper">
		<?php 
			...
			if(isset($disable_advanced) && $disable_advanced == true){ //only show if we are in preview mode
		?>
				<li class="eg-option-tabber selected" data-target="#eg-cobbles-options"><span style="font-size: 18px;line-height: 18px;margin-right: 10px;" class="dashicons dashicons-align-center"></span><?php _e('Cobbles Element Size', EG_TEXTDOMAIN); ?></li>
		<?php
			$selectedtab = "";
		}
		?>
	...
	if(isset($disable_advanced) && $disable_advanced == true){ //only show if we are in preview mode
		...
		?>
		<div id="eg-cobbles-options" class="eg-options-tab <?php echo $selectedtab; ?>">
			<!--<h2 style="margin-top:-6px"><?php _e('Grid specific settings', EG_TEXTDOMAIN); ?></h2>-->
			<div>
